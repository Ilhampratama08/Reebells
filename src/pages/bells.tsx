...
const homepage = () => {
    return(
        ...
        <main className="mx-[32rem]">
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4.5rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/adul.jpg" height={80} width={80}> 
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] opacity rounded-full" alt="bel" src="/prel.jpg" width={80} height={80}> 
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/ern.jpg" width={80} height={80}> 
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/jrt.jpg" width={80} height={80}>
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/kepin.jpg" width={80} height={80}>
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/edg.jpg" width={80} height={80}>
                   </Image>
            ...
            <div className=" mt-2 items-center">
                <div className="flex items-center">
                   <Image className="w-[4rem] h-[4rem] ms-[-1rem] rounded-full" alt="bel" src="/erk.jpg" width={80} height={80}>
                   </Image>
