        ...
        <main className="mx-[32rem]">
            <div className="flex justify-between mt-[4rem] items-center">
                <div className="flex items-center mt-[1rem]">
                  <div className="w-[5.5rem] h-[5.5rem] bg-[#D9D9D9] ms-[-1rem] opacity rounded-full items-center justify-center flex"><svg xmlns="http://www.w3.org/2000/svg" width="6em" height="4em" viewBox="0 0 16 16"><g fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"><circle cx="8" cy="6" r="3.25"/>
