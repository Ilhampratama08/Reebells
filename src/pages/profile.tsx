    ...
    return(
        ...
        <main className="mx-[32rem]">
            ...
            <div className="flex justify-between items-center">
                ...
                <Image className="w-[4rem] h-[4rem] ms-[rem] mt-[-1rem] rounded-full" alt="wow" src="/wow.jpg" width={80} height={80}> 
            </Image>
                <p className="ms-[1rem] mt-[-4rem]"><b>Kashim</b></p>
                <p className="ms-[-3.5em] mt-[rem]">Be yourself and never surrender</p>
                <button className="mt-[5rem] ms-[-14rem]"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 48 48"><path fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M15 8C8.925 8 4 12.925 4 19c0 11 13 21 20 23.326C31 40 44 30 44 19c0-6.075-4.925-11-11-11c-3.72 0-7.01 1.847-9 4.674A10.987 10.987 0 0 0 15 8"/></svg></button>
