...
const Navbar = () => {
  return (
    ...
    <div className="flex sm:justify-center space-x-7">
      <Link href="/" src="index.tsx" className="font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">
      ...
      <Link href="/bells" src="bells.tsx" className="font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">
        <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="2em" viewBox="0 0 256 256">
      ...
      <Link href="/post" src="/post.tsx" className="font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">
      ...
      <Link href="/search" src="/search.tsx" className="font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">
